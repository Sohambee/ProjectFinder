...
ActiveRecord::Schema.define(version: 2022_08_26_175224) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string "initiator_type", default: "Student", null: false
  ...
  create_table "volunteer_groups", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.string "description", default: "Used for personal project", null: false
  end
